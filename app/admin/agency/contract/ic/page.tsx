...
import { DataSchema,DataLabel,ValidationSchema,CountyData, StateData } from "@/app/admin/insurrance/cu/DataValidationSchema";
...
export default function InsuranceCreate() {
    ...
    const handleFormSubmit = async(values:any,{ resetForm }:any)=>{
        ...
        await axios.post(`${url}save-insurance`, 
            values.fetchdata, {
          ...
          if(response.data.error > 0){
            ...
            //resetForm();
            router.push('/admin/agency/contract')
          }         
            ...
            <div className="mt-[40px]">
                <div className="flex flex-row h-[29px]">
                    ...
                    <div className="ml-[50px] pt-[5px]">
                        <span className="text-[25px] font-medium capitalize text-[#4F4F4F]">Add Insurrance</span>
                    </div>
                </div>
