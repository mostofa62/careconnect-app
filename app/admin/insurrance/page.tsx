...
export default function Insurance() {
    ...
    
    {
        ...
        cell: info => <a className="text-[#0166FF] font-medium" href={`insurrance/caremanagers/${info.row.original._id}`}  rel="noopener noreferrer">{info.getValue()}</a>,
    },
    {
      accessorKey: 'address',
      header: 'Address',
            ...
            <div className="mt-8">
                <div className="flex flex-row h-[45px]">
                    <div className="py-[10px]">
                        <p className="text-[25px]  leading-[25px] capitalize  font-medium text-[#000000]">Insurance List</p>
                    </div>
                    ...
                    <div className="px-10">
                        ...
                        >
                            ...
                            <p className="text-[18px] font-medium">Add Insurance</p>
                        </Link>
                    </div>
                </div>
            </div>
            ...
            <tr key={headerGroup.id}>
              {headerGroup.headers.map(header => (
                ...
                {table.getRowModel().rows.map((row:any) => {
                    ...
                    <div  style={{ height:`${hoveredRowHeight ? hoveredRowHeight-1:20}px`,paddingTop:`${hoveredRowHeight ? ((hoveredRowHeight/4)):5}px`, paddingBottom:`${hoveredRowHeight ? ((hoveredRowHeight/4)):5}px` }} className={`absolute float-right right-3.5 px-3.5 w-[10%] flex flex-row bg-white`}>
                    <div> 
                    <Link  title="Edit" className={`cursor-pointer hover:text-[#0166FF]`}  href={`insurrance/cu/${row.getValue('_id')}`}>
