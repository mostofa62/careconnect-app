...
export default function Marketer() {
    ...
    
    {
        ...
        //cell: info => <a className="text-[#0166FF] font-medium" href={`marketer/caremanagers/${info.row.original._id}`}  rel="noopener noreferrer">{info.getValue()}</a>,
    },
    {
      accessorKey: 'address',
      header: 'Address',
            ...
            <div className="mt-[40px]">
                <div className="flex flex-row h-[45px]">
                    <div className="py-[10px]">
                        <p className="text-[25px]  leading-[25px] capitalize  font-medium text-[#000000]">Marketer List</p>
                    </div>
                    ...
                    <div className="px-10">
                        ...
                        >
                            ...
                            <p className="text-[18px] font-medium">Add Marketer</p>
                        </Link>
                    </div>
                </div>
            </div>
                    ...
                    <GridActionLink items={[
                      {
                        actionId:'edit',
                        title:'Edit',
                        link:`marketer/cu/${row.getValue('_id')}`,                        
