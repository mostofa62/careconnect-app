...
*/}
      ...
      >
        {
        <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark text-[#4F4F4F]">
          
          <li>
            <Link
              href={/*(Loguser && Loguser == '1')?*/'/admin/profile'/*:'/user/profile'*/}
              className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-[#0166FF] lg:text-base"
            >
              <svg
        ...
        */}
        ...
        <button onClick={logoutHandler} className="flex items-center gap-3.5 py-4 px-6 text-sm font-medium duration-300 ease-in-out hover:text-[#0166FF] lg:text-base">
          <svg
            className="fill-current"
            width="22"
            height="22"
